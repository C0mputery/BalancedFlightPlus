...
public class FlightDisruptorKineticInstance extends KineticBlockEntityInstance<FlightDisruptorEntity> implements DynamicInstance
{
    protected final EnumMap<Direction, RotatingData> keys = new EnumMap(Direction.class);
    protected Direction sourceFacing;

    public FlightDisruptorKineticInstance(MaterialManager materialManager, FlightDisruptorEntity blockEntity) {
