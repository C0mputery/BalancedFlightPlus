...
import com.computery.balancedflightplus.content.flightDisruptor.entity.FlightDisruptorBehaviour;
import com.computery.balancedflightplus.content.flightDisruptor.entity.FlightDisruptorEntity;
import net.minecraft.core.BlockPos;
import net.minecraft.core.Direction;

public class FlightDisruptorPonderScene {
    public FlightDisruptorPonderScene() { }
    ...
    public static void ponderScene(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.modifyBlockEntity(flightAnchorPos, FlightDisruptorEntity.class, entity -> {
            FlightDisruptorBehaviour.beaconTick(entity.getLevel(), entity.getBlockPos(), entity);
        });
